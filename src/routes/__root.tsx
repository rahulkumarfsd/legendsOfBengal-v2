...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Authentic Bengali heritage, elevated. A modern premium restaurant in Asansol serving signature seafood, Bengali classics and chef's selections." },
      { name: "author", content: "Legends of Bengal" },
